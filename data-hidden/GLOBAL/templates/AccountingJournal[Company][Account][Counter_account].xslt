...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="Header">
    ...
    <xsl:choose>
      <xsl:when test="AccountType = 'payroll_mgmt_acc_entry'">
        <xsl:choose>
          <xsl:when test="/Report/@lang = 'fr'">
            <xsl:text>BEBU Journal: Auswertung nach Firma / Konto / Gegenkonto</xsl:text>
          </xsl:when>
      ...
      <xsl:otherwise>
        <xsl:choose>
          <xsl:when test="/Report/@lang = 'fr'">
            <xsl:text>FIBU Journal: Auswertung nach Firma / Konto / Gegenkonto</xsl:text>
          </xsl:when>
          <xsl:when test="/Report/@lang = 'it'">
            <xsl:text>FIBU Journal: Auswertung nach Firma / Konto / Gegenkonto</xsl:text>
          </xsl:when>
  ...
  <xsl:template match="Company">
    <!--HEADER-->
    \renewcommand*{\arraystretch}{1.1}
    \begin{longtable}{@{\extracolsep{\fill}}l l r r l}
