...
<xsl:when test="/Report/@lang = 'fr'"><xsl:text>Kontierte Mitarbeiter FIBU</xsl:text></xsl:when>
<xsl:when test="/Report/@lang = 'it'"><xsl:text>Kontierte Mitarbeiter FIBU</xsl:text></xsl:when>
<xsl:otherwise><xsl:text>Kontierte Mitarbeiter FIBU</xsl:text></xsl:otherwise>
</xsl:choose>}\\
\vspace{2mm}
