...
\\
<xsl:choose>
<xsl:when test="/Report/@lang = 'fr'"><xsl:text>\textbf{LOA}&amp;\textbf{Bezeichnung}&amp;\textbf{M/B}&amp;\textbf{Januar}&amp;\textbf{Februar}&amp;\textbf{März}&amp;\textbf{April}&amp;\textbf{Mai}&amp;\textbf{Juni}&amp;\textbf{Juli}&amp;
\\&amp;&amp;&amp;\textbf{August}&amp;\textbf{September}&amp;\textbf{Oktober}&amp;\textbf{November}&amp;\textbf{Dezember}</xsl:text></xsl:when>
<xsl:when test="/Report/@lang = 'it'"><xsl:text>\textbf{LOA}&amp;\textbf{Bezeichnung}&amp;\textbf{M/B}&amp;\textbf{Januar}&amp;\textbf{Februar}&amp;\textbf{März}&amp;\textbf{April}&amp;\textbf{Mai}&amp;\textbf{Juni}&amp;\textbf{Juli}&amp;
\\&amp;&amp;&amp;\textbf{August}&amp;\textbf{September}&amp;\textbf{Oktober}&amp;\textbf{November}&amp;\textbf{Dezember}</xsl:text></xsl:when>
<xsl:otherwise><xsl:text>\textbf{LOA}&amp;\textbf{Bezeichnung}&amp;\textbf{M/B}&amp;\textbf{Januar}&amp;\textbf{Februar}&amp;\textbf{März}&amp;\textbf{April}&amp;\textbf{Mai}&amp;\textbf{Juni}&amp;\textbf{Juli}&amp;
\\&amp;&amp;&amp;\textbf{August}&amp;\textbf{September}&amp;\textbf{Oktober}&amp;\textbf{November}&amp;\textbf{Dezember}</xsl:text></xsl:otherwise>
...
<xsl:template match="Entry"><xsl:if test="quantity"><xsl:value-of select="AccountNumber"/>&amp;<xsl:value-of select="AccountName"/>&amp;M&amp;<xsl:if test="quantity/Jan != 0"><xsl:value-of select="format-number(quantity/Jan,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/Feb != 0"><xsl:value-of select="format-number(quantity/Feb,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/Mar != 0"><xsl:value-of select="format-number(quantity/Mar,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/Apr != 0"><xsl:value-of select="format-number(quantity/Apr,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/May != 0"><xsl:value-of select="format-number(quantity/May,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/June != 0"><xsl:value-of select="format-number(quantity/June,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/July != 0"><xsl:value-of select="format-number(quantity/July,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;
\\&amp;&amp;&amp;<xsl:if test="quantity/Aug != 0"><xsl:value-of select="format-number(quantity/Aug,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/Sept != 0"><xsl:value-of select="format-number(quantity/Sept,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/Oct != 0"><xsl:value-of select="format-number(quantity/Oct,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/Nov != 0"><xsl:value-of select="format-number(quantity/Nov,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="quantity/Dec != 0"><xsl:value-of select="format-number(quantity/Dec,&quot;#'##0.00&quot;,'apodot')"/></xsl:if><xsl:if test="/Report/Header/ExtendedMonthView/Prd13">&amp;<xsl:if test="quantity/Prd13 != 0"><xsl:value-of select="format-number(quantity/Prd13,&quot;#'##0.00&quot;,'apodot')"/></xsl:if></xsl:if><xsl:if test="/Report/Header/ExtendedMonthView/Prd14">&amp;<xsl:if test="quantity/Prd14 != 0"><xsl:value-of select="format-number(quantity/Prd14,&quot;#'##0.00&quot;,'apodot')"/></xsl:if></xsl:if><xsl:if test="/Report/Header/ExtendedMonthView/Prd15">&amp;<xsl:if test="quantity/Prd15 != 0"><xsl:value-of select="format-number(quantity/Prd15,&quot;#'##0.00&quot;,'apodot')"/></xsl:if></xsl:if><xsl:if test="/Report/Header/ExtendedMonthView/Prd16">&amp;<xsl:if test="quantity/Prd16 != 0"><xsl:value-of select="format-number(quantity/Prd16,&quot;#'##0.00&quot;,'apodot')"/></xsl:if></xsl:if>&amp;<xsl:if test="amount/Total != 0"><xsl:value-of select="format-number(quantity/Total,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>\\
</xsl:if>
<xsl:if test="amount"><xsl:value-of select="AccountNumber"/>&amp;<xsl:value-of select="AccountName"/>&amp;B&amp;<xsl:if test="amount/Jan != 0"><xsl:value-of select="format-number(amount/Jan,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/Feb != 0"><xsl:value-of select="format-number(amount/Feb,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/Mar != 0"><xsl:value-of select="format-number(amount/Mar,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/Apr != 0"><xsl:value-of select="format-number(amount/Apr,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/May != 0"><xsl:value-of select="format-number(amount/May,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/June != 0"><xsl:value-of select="format-number(amount/June,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/July != 0"><xsl:value-of select="format-number(amount/July,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;
\\&amp;&amp;&amp;<xsl:if test="amount/Aug != 0"><xsl:value-of select="format-number(amount/Aug,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/Sept != 0"><xsl:value-of select="format-number(amount/Sept,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/Oct != 0"><xsl:value-of select="format-number(amount/Oct,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/Nov != 0"><xsl:value-of select="format-number(amount/Nov,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>&amp;<xsl:if test="amount/Dec != 0"><xsl:value-of select="format-number(amount/Dec,&quot;#'##0.00&quot;,'apodot')"/></xsl:if><xsl:if test="/Report/Header/ExtendedMonthView/Prd13">&amp;<xsl:if test="amount/Prd13 != 0"><xsl:value-of select="format-number(amount/Prd13,&quot;#'##0.00&quot;,'apodot')"/></xsl:if></xsl:if><xsl:if test="/Report/Header/ExtendedMonthView/Prd14">&amp;<xsl:if test="amount/Prd14 != 0"><xsl:value-of select="format-number(amount/Prd14,&quot;#'##0.00&quot;,'apodot')"/></xsl:if></xsl:if><xsl:if test="/Report/Header/ExtendedMonthView/Prd15">&amp;<xsl:if test="amount/Prd15 != 0"><xsl:value-of select="format-number(amount/Prd15,&quot;#'##0.00&quot;,'apodot')"/></xsl:if></xsl:if><xsl:if test="/Report/Header/ExtendedMonthView/Prd16">&amp;<xsl:if test="amount/Prd16 != 0"><xsl:value-of select="format-number(amount/Prd16,&quot;#'##0.00&quot;,'apodot')"/></xsl:if></xsl:if>&amp;&amp;&amp;<xsl:if test="amount/Total != 0"><xsl:value-of select="format-number(amount/Total,&quot;#'##0.00&quot;,'apodot')"/></xsl:if>\\
</xsl:if>
</xsl:template>
