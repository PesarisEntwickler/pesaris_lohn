...
$objLanguageManager->register('de', array(
	...
	'XJXCTL:IAERR:01' => 'Ungueltiges Attribut [',
	'XJXCTL:IAERR:02' => '] fuer Element [',
	'XJXCTL:IAERR:03' => '].',
	'XJXCTL:IRERR:01' => 'Ungueltiges Request-Objekt uebergeben an xajaxControl::setEvent',
	'XJXCTL:IEERR:01' => 'Ungueltiges Attribut (event name) [',
	'XJXCTL:IEERR:02' => '] fuer Element [',
	'XJXCTL:IEERR:03' => '].',
	'XJXCTL:MAERR:01' => 'Erforderliches Attribut fehlt [',
	'XJXCTL:MAERR:02' => '] fuer Element [',
	'XJXCTL:MAERR:03' => '].',
	'XJXCTL:IETERR:01' => "Ungueltiges End-Tag; Sollte 'forbidden' oder 'optional' sein.\n",
	'XJXCTL:ICERR:01' => "Ungueltige Klasse fuer html control angegeben.; Sollte %inline, %block oder %flow sein.\n",
	'XJXCTL:ICLERR:01' => 'Ungueltige Klasse (control) an addChild uebergeben; Sollte abgeleitet sein von xajaxControl.',
	'XJXCTL:ICLERR:02' => 'Ungueltige Klasse (control) an addChild uebergeben [',
	'XJXCTL:ICLERR:03' => '] fuer Element [',
	'XJXCTL:ICLERR:04' => "].\n",
	'XJXCTL:ICHERR:01' => 'Ungueltiger Parameter uebergeben fuer xajaxControl::addChildren; Array aus xajaxControl Objekten erwartet.',
	'XJXCTL:MRAERR:01' => 'Erforderliches Attribut fehlt [',
	'XJXCTL:MRAERR:02' => '] fuer Element [',
	'XJXCTL:MRAERR:03' => '].',
	'XJXPLG:GNERR:01' => 'Response plugin sollte die Funktion getName ueberschreiben.',
	'XJXPLG:PERR:01' => 'Response plugin sollte die process Funktion ueberschreiben.',
	'XJXPM:IPLGERR:01' => 'Versuch ungueltiges Plugin zu registrieren: : ',
	'XJXPM:IPLGERR:02' => ' Ableitung von xajaxRequestPlugin oder xajaxResponsePlugin erwartet.',
	'XJXPM:MRMERR:01' => 'Konnte die Registrierungsmethode nicht finden fuer: : ',
	...
	'XJXRSP:MPERR:01' => 'Ungueltiger oder fehlender Pluginname festgestellt im Aufruf von xajaxResponse::plugin',
	'XJXRSP:CPERR:01' => "Der Parameter \$sType in addCreate ist veraltet.  Die neue Funktion lautet addCreateInput()",
	'XJXRSP:LCERR:01' => "Das xajax response Objeckt konnte die Befehler nich verarbeiten, da kein gueltiges Array uebergeben wurde.",
	'XJXRSP:AKERR:01' => 'Ungueltiger Tag-Name im Array.',
	'XJXRSP:IEAERR:01' => 'Ungeeignet kodiertes Array.',
	'XJXRSP:NEAERR:01' => 'Nicht kodiertes Array festgestellt.',
	'XJXRSP:MBEERR:01' => 'Die Ausgabe vonn xajax response konnte nicht in htmlentities umgewandelt werden, da die Funktion mb_convert_encoding nicht verfuegbar ist.',
	...
	'XJXRM:IRERR' => 'Ungueltige Antwort erhalten waehrend der Ausfuehrung der Anfrage.',
	'XJXRM:MXRTERR' => 'Fehler: Kann kkeine verschiedenen reponse types benutzen waehrend der Ausfuehrung einer Anfrage: '
	));
